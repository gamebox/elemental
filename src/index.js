...
const kebabCase = (str) => str.replace(/[A-Z]/g, (a, b) => `-${a.toLowerCase()}`);

const DISPATCH = Symbol("DISPATCH");
const PROPS = Symbol("Props");
const SINK_NAME = Symbol('Sink Name');
const SELECT_SINK_PROP = Symbol('Select Sink Prop');
const WATCHERS = Symbol('Sink Watchers');
